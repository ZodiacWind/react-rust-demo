...
use tauri::{
    CustomMenuItem, Manager, Menu, MenuItem, Submenu, SystemTray, SystemTrayMenu,
...
async fn my_custom_command_handle(app_handle: tauri::AppHandle) {
    ...
    let _ = app_handle
        ...
        .register("CTRL + U", move || println!("热键。。。。"));
}
//全局状态
...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            my_custom_command,
            my_custom_command_param,
            my_custom_command_return,
            my_custom_command_result,
            my_custom_command_async,
            my_custom_command_windows,
            my_custom_command_handle,
            my_custom_command_state,
